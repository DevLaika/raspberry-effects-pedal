...
/* -- Define Input Pins -- */
//UI-Switch
#define SWITCH RPI_V2_GPIO_P1_03 //GPIO02
//Push buttons
#define PUSH0 RPI_V2_GPIO_P1_05 //GPIO03
#define PUSH1 RPI_V2_GPIO_P1_07 //GPIO04
#define PUSH2 RPI_V2_GPIO_P1_29 //GPIO05
#define PUSH3 RPI_V2_GPIO_P1_31 //GPIO06
//Bypass Switch
#define BYPASS RPI_V2_GPIO_P1_26 //GPIO07
//LED
#define LED RPI_V2_GPIO_P1_40 //GPIO21
//Stomp buttons
#define FOOT0 RPI_V2_GPIO_P1_08 //GPIO14
#define FOOT1 RPI_V2_GPIO_P1_10 //GPIO15
#define FOOT2 RPI_V2_GPIO_P1_36 //GPIO16
#define FOOT3 RPI_V2_GPIO_P1_11 //GPIO17
//Rotary encoder
#define ROTS RPI_V2_GPIO_P1_35 //GPIO19
#define ROTA RPI_V2_GPIO_P1_38 //GPIO20
#define ROTB RPI_V2_GPIO_P1_32 //GPIO12
//LCD Display
/* 
LCD DISPLAY DEFINITIONS ARE MANAGED IN LCDHD44780.h
#define DISPRS RPI_V2_GPIO_P1_15 //GPIO22
#define DISPE RPI_V2_GPIO_P1_16  //GPIO23
#define DISPD4 RPI_V2_GPIO_P1_18 //GPIO24
#define DISPD5 RPI_V2_GPIO_P1_22 //GPIO25
#define DISPD6 RPI_V2_GPIO_P1_37 //GPIO26
#define DISPD7 RPI_V2_GPIO_P1_13 //GPIO27
*/
...
int main(int argc, char **argv)
{
  ...
  bcm2835_gpio_fsel(PUSH0, BCM2835_GPIO_FSEL_INPT);  //PUSH2 button as input
  ...
  bcm2835_gpio_fsel(PUSH3, BCM2835_GPIO_FSEL_INPT);  //PUSH1 button as input
  bcm2835_gpio_fsel(BYPASS, BCM2835_GPIO_FSEL_INPT); //FOOT_SWITCH as input
  bcm2835_gpio_fsel(SWITCH, BCM2835_GPIO_FSEL_INPT); //TOGGLE_SWITCH as input

  bcm2835_gpio_set_pud(PUSH0, BCM2835_GPIO_PUD_UP);  //PUSH1 pull-up enabled
  ...
  bcm2835_gpio_set_pud(PUSH3, BCM2835_GPIO_PUD_UP);  //PUSH2 pull-up enabled
  bcm2835_gpio_set_pud(BYPASS, BCM2835_GPIO_PUD_UP); //FOOT_SWITCH pull-up enabled
  bcm2835_gpio_set_pud(SWITCH, BCM2835_GPIO_PUD_UP); //TOGGLE_SWITCH pull-up enabled
  ...
  while (1) //Main Loop
  {
    ...
    */
    ...
    //**** CLEAN EFFECT ***///
    //Nothing to do, the input_signal goes directly to the PWM output_signal.
